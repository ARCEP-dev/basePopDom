...
Bâtiments :
- Cadastre/bati [PCI retraité par Etalab](https://cadastre.data.gouv.fr/datasets/cadastre-etalab) - 2021 - Format : GeoJSON, SRID : WGS84, EPSG : 4326

Population :
- [Population - recensement infracommunal 2017 France hors Mayotte + Collectivités d'outre-mer](https://www.insee.fr/fr/statistiques/4799309) - 2017 - Format : csv
- [Population - recensement communal 2017 pour Mayotte](https://www.insee.fr/fr/statistiques/3286558) - 2017 - Format : Excel (xls)

Zones de référence :
- [Zones IRIS INSEE/IGN 2021](https://geoservices.ign.fr/contoursiris#telechargement) - 2021- Format : Shapefile, SRID : local, EPSG : local
- [Commune IGN juin 2021 pour Mayotte](https://geoservices.ign.fr/adminexpress) - 2021 - Format : Shapefile, SRID : RGM04_UTM_zone_38S, EPSG : 4471
...
wget -O %sigDirectory%\etalab\cadastre\2021\971_bati.json.gz --no-check-certificate https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/departements/971/cadastre-971-batiments.json.gz
wget -O %sigDirectory%\etalab\cadastre\2021\972_bati.json.gz --no-check-certificate https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/departements/972/cadastre-972-batiments.json.gz
wget -O %sigDirectory%\etalab\cadastre\2021\973_bati.json.gz --no-check-certificate https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/departements/973/cadastre-973-batiments.json.gz
wget -O %sigDirectory%\etalab\cadastre\2021\974_bati.json.gz --no-check-certificate https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/departements/974/cadastre-974-batiments.json.gz
wget -O %sigDirectory%\etalab\cadastre\2021\976_bati.json.gz --no-check-certificate https://cadastre.data.gouv.fr/data/etalab-cadastre/latest/geojson/departements/976/cadastre-976-batiments.json.gz
...
ogr2ogr -f "ESRI Shapefile" %sigDirectory%\etalab\cadastre\2021\971_bati_valid.shp %sigDirectory%\etalab\cadastre\2021\971_bati.json -dialect sqlite -sql "SELECT ST_MakeValid(geometry) AS geometry, type, nom, commune  FROM \"971_bati\" WHERE GeometryType(ST_MakeValid(geometry)) IN ('POLYGON', 'MULTIPOLYGON')"
ogr2ogr -f "ESRI Shapefile" %sigDirectory%\etalab\cadastre\2021\972_bati_valid.shp %sigDirectory%\etalab\cadastre\2021\972_bati.json -dialect sqlite -sql "SELECT ST_MakeValid(geometry) AS geometry, type, nom, commune  FROM \"972_bati\" WHERE GeometryType(ST_MakeValid(geometry)) IN ('POLYGON', 'MULTIPOLYGON')"
ogr2ogr -f "ESRI Shapefile" %sigDirectory%\etalab\cadastre\2021\973_bati_valid.shp %sigDirectory%\etalab\cadastre\2021\973_bati.json -dialect sqlite -sql "SELECT ST_MakeValid(geometry) AS geometry, type, nom, commune  FROM \"973_bati\" WHERE GeometryType(ST_MakeValid(geometry)) IN ('POLYGON', 'MULTIPOLYGON')"
ogr2ogr -f "ESRI Shapefile" %sigDirectory%\etalab\cadastre\2021\974_bati_valid.shp %sigDirectory%\etalab\cadastre\2021\974_bati.json -dialect sqlite -sql "SELECT ST_MakeValid(geometry) AS geometry, type, nom, commune  FROM \"974_bati\" WHERE GeometryType(ST_MakeValid(geometry)) IN ('POLYGON', 'MULTIPOLYGON')"
ogr2ogr -f "ESRI Shapefile" %sigDirectory%\etalab\cadastre\2021\976_bati_valid.shp %sigDirectory%\etalab\cadastre\2021\976_bati.json -dialect sqlite -sql "SELECT ST_MakeValid(geometry) AS geometry, type, nom, commune  FROM \"976_bati\" WHERE GeometryType(ST_MakeValid(geometry)) IN ('POLYGON', 'MULTIPOLYGON')"
```

#### Chargement des données en base

```sh
shp2pgsql -D -c -g geom -s 4326 %sigDirectory%\etalab\cadastre\2021\971_bati_valid.shp import.bati | psql
shp2pgsql -D -a -g geom -s 4326 %sigDirectory%\etalab\cadastre\2021\972_bati_valid.shp import.bati | psql
shp2pgsql -D -a -g geom -s 4326 %sigDirectory%\etalab\cadastre\2021\973_bati_valid.shp import.bati | psql
shp2pgsql -D -a -g geom -s 4326 %sigDirectory%\etalab\cadastre\2021\974_bati_valid.shp import.bati | psql
shp2pgsql -D -a -g geom -s 4326 %sigDirectory%\etalab\cadastre\2021\976_bati_valid.shp import.bati | psql
```
...
- traitement via ogr2ogr des fichiers métropole et COM pour exporter seulement les colonnes utiles (IRIS, REG, DEP, COM, TYP_IRIS, LAB_IRIS, P13_POP) et les lignes correspondant à des départements d'OM.

```sh
# DOM
ogr2ogr -f "CSV" %sigDirectory%\insee\recensement\2017\pop_2017.csv %sigDirectory%\insee\recensement\2017\base-ic-evol-struct-pop-2017.csv -sql "SELECT iris, reg, dep, com, typ_iris, lab_iris, p17_pop AS pop FROM \"base-ic-evol-struct-pop-2017\" WHERE dep LIKE '97%'"

# St Martin & St Barthélemy
ogr2ogr -f "CSV" %sigDirectory%\insee\recensement\2017\pop_st_mb_2017.csv %sigDirectory%\insee\recensement\2017\base-ic-evol-struct-pop-2017-com.csv -sql "SELECT iris, null AS reg, dep, com, null AS typ_iris, lab_iris, p17_pop AS pop FROM \"base-ic-evol-struct-pop-2017-com\""
```
...
```sh
psql -c "\copy import.recensement FROM '%sigDirectory%\insee\recensement\2017\pop_2017.csv' CSV HEADER DELIMITER ',';"
psql -c "\copy import.recensement FROM '%sigDirectory%\insee\recensement\2017\pop_st_mb_2017.csv' CSV HEADER DELIMITER ',';"
...
shp2pgsql -D -c -g geom -s 5490:4326  %sigDirectory%\IRIS-GE_2-0__SHP_RGAF09UTM20_GLP_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_RGAF09UTM20_GLP-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop

shp2pgsql -D -a -g geom -s 5490:4326  %sigDirectory%\IRIS-GE_2-0__SHP_RGAF09UTM20_MTQ_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_RGAF09UTM20_MTQ-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop

shp2pgsql -D -a -g geom -s 2972:4326  %sigDirectory%\IRIS-GE_2-0__SHP_UTM22RGFG95_GUF_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_UTM22RGFG95_GUF-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop

shp2pgsql -D -a -g geom -s 2975:4326  %sigDirectory%\IRIS-GE_2-0__SHP_RGR92UTM40S_REU_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_RGR92UTM40S_REU-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop

shp2pgsql -D -a -g geom -s 5490:4326  %sigDirectory%\IRIS-GE_2-0__SHP_RGAF09UTM20_SBA_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_RGAF09UTM20_SBA-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop

shp2pgsql -D -a -g geom -s 5490:4326  %sigDirectory%\IRIS-GE_2-0__SHP_RGAF09UTM20_SMA_2021-01-01\IRIS-GE\1_DONNEES_LIVRAISON_2021-06-00135\IRIS-GE_2-0_SHP_RGAF09UTM20_SMA-2021\IRIS_GE.SHP import.zone_iris | "C:\Program Files\PostgreSQL\12\bin\psql.exe" -d dom_pop
...
Patch pour la commune de Maripalousa (97353) : plusieurs iris dans zone_iris, un seul iris dans le recensement
